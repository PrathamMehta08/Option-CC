...
const ALIASES: Record<string, NumericField> = Object.assign(Object.create(null), {
  ...
  annifassigned: 'annualizedReturnWithGain',
  ifassigned: 'annualizedReturnWithGain',
  ifcalled: 'annualizedReturnWithGain',
  totalreturn: 'annualizedReturnWithGain',
  premiumshare: 'premiumSharePct',
  premshare: 'premiumSharePct',
  totalifassigned: 'totalProfitIfAssigned',
  profitifassigned: 'totalProfitIfAssigned',
